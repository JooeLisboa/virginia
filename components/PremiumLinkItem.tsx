...
export function PremiumLinkItem({ title, description, href, tag, accent, icon }: PremiumLinkItemProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className={cn('absolute inset-0 bg-gradient-to-r opacity-70', accent)} />
        <div className="absolute inset-[1px] rounded-[1.45rem] bg-[linear-gradient(180deg,rgba(11,14,31,0.74),rgba(12,14,32,0.86))]" />
        <motion.div
        ...
        <div className="relative z-10 flex items-start gap-3.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h2 className="text-base font-semibold tracking-[-0.03em] text-white">{title}</h2>
            <p className="mt-1 text-sm leading-relaxed text-white/66">{description}</p>
          </div>
        </div>
      </Link>
    </motion.li>
